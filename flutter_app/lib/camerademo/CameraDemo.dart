...
//  VoidCallback voidPlayerListener;
...
//                color: Colors.black,
//                border: Border.all(
//                  color: controller !=null && controller.value.isRecordingVideo ? Colors.redAccent : Colors.grey,width: 3.0,
//                ),
//              ),
//            ),
//          ),
...
//        children: <Widget>[
//          const Text('开始录音'),
//          Switch(value: enableAudio, onChanged: (bool value) {
//            enableAudio = value;
//            if(controller != null){
//              onNewCameraSelected(controller.description);
//            }
...
//    }
//    controller = CameraController(cameraDescription, ResolutionPreset.high , enableAudio: enableAudio);
...
//      if(mounted) setState(() {
//      });
//      if(filePath !=null) showInSnackBar('正在保存视频 $filePath');
//    });
//  }
//  //终止视频录制
...
//    final String dirPath = '${exDir.path}/Movies/flutter_test';
...
//
//        });
//        videoController.removeListener(voidPlayerListener);
//      }
//    };
//    vcontroller.addListener(voidPlayerListener);
...
//    }
//    final Directory exDir = await getApplicationDocumentsDirectory();
//    final String dirPath = '${exDir.path}/Pictures/flutter_test';
//    await Directory(dirPath).create(recursive: true);
