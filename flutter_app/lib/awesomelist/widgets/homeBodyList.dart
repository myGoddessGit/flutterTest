...
import 'package:flutter_app/awesomelist/views/details.dart';
...
class HomeBodyList extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return Transform.translate(
      offset: Offset(0.0, MediaQuery.of(context).size.height * offset),
      child: Container(
        height:
        MediaQuery.of(context).size.height * (1 - offset) - CONSTANT.appBarHeight,
                ...
                Transform.translate(
                  ...
                  child: Card(
                    ...
                    child: Container(
                      ...
                      child: Hero(
                        tag: index,
                        child: FadeInImage(placeholder: AssetImage('assets/loading.gif'), image: NetworkImage(data.image),fit:BoxFit.cover),
                      ),
                    ),
                  ),
                )
