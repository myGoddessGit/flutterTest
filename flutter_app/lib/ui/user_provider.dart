...
/**
 * 利用InheriteWidget用于子节点向祖先节点获取数据
 * 当依赖的InheriteWidget rebuild,会触发子控件的didChangeDependencies()接口
*/
class UserProvider extends InheritedWidget{
  final Widget child;
  final User user;//在子树中共享数据

  UserProvider({this.user,this.child}) : super(child : child);

/**
 *该回调决定当数据发生变化时，是否通知子树中的依赖数据的Widget
 */
  @override
 ...
 * 将我们的继承于InheritedWidget组件build出去
 *
 */
